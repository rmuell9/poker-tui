...
1. Start with a simple text-based terminal game with fixed probabilities for each hand flop, turn, and river
...
Extras:
implement poker card evaluation tool for statistics and bot behavior
